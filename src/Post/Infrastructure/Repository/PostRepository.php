...
final class PostRepository implements PostRepositoryInterface
{
    public function find(PostIdentifier $postIdentifier): ?Post
    {
        ...
        return Post::create(new PostIdentifier($model->post_identifier), new RoutineIdentifier($model->routine_identifier), PostCategory::from($model->post_category), new PostLikeCount($model->post_like_count), new PostSupportCount($model->post_support_count));
    }
