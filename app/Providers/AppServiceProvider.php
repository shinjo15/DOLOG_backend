...
use Src\Follow\Infrastructure\Repository\FollowedAccountRepository;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register(): void
    {
        ...
        $this->app->bind(FollowedAccountRepositoryInterface::class, FollowedAccountRepository::class);
